...
public class bien_huycan extends AppCompatActivity {
    //Khai báo biến
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bien_huycan);
        ...
        try {
            String sql = "CREATE TABLE bien(macau TEXT primary key, cau TEXT)";
        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myvalue.put("cau",cau);
                String msg = "";
                if(mydatabase.insert("bien", "", myvalue) == -1){
                    msg= "FALL to Insert Record";
                }else {
                    msg = "Insert Record Successfully";
                }
                Toast.makeText(bien_huycan.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
        reload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mylist.clear();
                Cursor c = mydatabase.query("bien", null,null, null, null,null,null);
                c.moveToNext();
                String data = "";
